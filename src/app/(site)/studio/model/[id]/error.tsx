...
export default function ModelError({ reset }: { reset: () => void }) {
  return (
    <div className="text-center py-24 px-4 animate-fade-in">
      ...
      <h3 className="text-lg font-bold text-foreground mb-2">לא ניתן לטעון את פרטי המודל</h3>
      <p className="text-muted text-sm mb-6 max-w-sm mx-auto">
        ייתכן שהמודל אינו זמין כרגע, או שמקור המודל אינו מגיב. אפשר לנסות שוב.
      </p>
